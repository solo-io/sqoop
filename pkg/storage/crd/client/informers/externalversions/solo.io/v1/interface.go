...
type Interface interface {
	// ResolverMaps returns a ResolverMapInformer.
	ResolverMaps() ResolverMapInformer
...
// ResolverMaps returns a ResolverMapInformer.
func (v *version) ResolverMaps() ResolverMapInformer {
	return &resolverMapInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
