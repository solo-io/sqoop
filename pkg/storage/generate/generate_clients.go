...
var clients = []clientType{
	{
		...
		LowercasePluralName: "schemas",
		UppercaseName:       "Schema",
		UppercasePluralName: "Schemas",
	},
	{
		FilenamePrefix:      "resolver_maps",
		LowercaseName:       "resolverMap",
		LowercasePluralName: "resolverMaps",
		UppercaseName:       "ResolverMap",
		UppercasePluralName: "ResolverMaps",
	},
}
