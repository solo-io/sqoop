...
require (
	...
	github.com/helm/helm v2.14.0+incompatible // indirect
...
replace (
	...
	k8s.io/apiserver => k8s.io/apiserver v0.0.0-20181204001702-9caa0299108f
	k8s.io/cli-runtime => k8s.io/cli-runtime v0.0.0-20181204004549-a04da5c88c07
